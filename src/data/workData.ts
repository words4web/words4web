...
export const workData: WorkItem[] = [
  {
    title: "Dadoos",
    subtitle: "Same-Day Grocery Delivery At Your Doorstep",
    services: "Website Development + SEO + Social Media",
    description:
  ...
  {
    title: "Box2Box Sports",
    subtitle: "Kickstart Your Football Journey",
    services: "Website Development + SEO + Creative Graphics",
    description:
  ...
  {
    title: "Filipe Carrera",
    subtitle: "Empowering Leaders and Organizations Worldwide",
    services: "Website Development + Digital Branding",
    description:
