  ...
  (
    ...
    const headerContent = (badge || title || description) && (
      <div
        ...
        {badge && (
          <div className="inline-flex items-center gap-2.5 px-4.5 py-2 rounded-full bg-[var(--primary)]/15 border border-[var(--primary)]/35 mb-6 shadow-[0_2px_12px_rgba(123,44,191,0.08)]">
        ...
        {description && (
          <p className="mt-6 text-lg md:text-xl text-[var(--text-primary)] font-medium leading-relaxed max-w-3xl">
            {description}
          </p>
        )}
      </div>
