        ...
        <motion.div
          ...
          <div
            ...
            <div className="flex flex-col gap-4 text-left">
              <span className="text-[var(--primary-text)] font-display text-xs uppercase tracking-widest font-semibold">
            ...
            <div className="flex items-center text-sm font-semibold text-[var(--primary-text)] mt-4">
