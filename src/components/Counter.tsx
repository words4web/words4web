...
export function Counter({
  ...
  return (
    <div
      ref={ref}
      className="relative p-[3px] rounded-3xl overflow-hidden group hover:-translate-y-1 transition-transform duration-500 select-none">
      {/* Glowing Line Tracing Around Border (Always Visible) */}
