...
export function MobileFrameCard({
  ...
  const cardContent = (
    <div
      className={`group relative w-full ${forcePortrait ? "max-w-[500px]" : "max-w-[260px]"} rounded-3xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 select-none ${
